...
export default async function NewPropertyPage(){
  ...
  if(error||!context?.allowed)return <DashboardShell title="Post property" description="Property posting permission"><section className="dashboard-card empty-state"><p>{POSTING_ENTITLEMENT_MESSAGE}</p><PostingEntitlementActions/></section></DashboardShell>;
