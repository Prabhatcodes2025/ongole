...
export default async function NewPgPage(){
  ...
  if(error||!(permission as {allowed?:boolean}|null)?.allowed)return <main id="main" className="portal-page"><div className="shell narrow-shell"><section className="dashboard-card empty-state"><h1>Property posting permission</h1><p>{POSTING_ENTITLEMENT_MESSAGE}</p><a className="button" href="tel:+917788998459">Contact admin</a></section></div></main>;
