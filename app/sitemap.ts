...
const staticRoutes=["","/about","/services","/properties","/paying-guest","/nri-services-ongole","/agents","/advertise-with-us","/contact","/privacy-policy","/terms-and-conditions","/disclaimer","/property-listing-policy","/membership-policy","/advertisement-policy","/cookie-policy","/copyright-policy","/contact-grievance-policy"];
