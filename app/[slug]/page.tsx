...
const pages: Record<string, { title: string; eyebrow: string; intro: string; sections: { title: string; body: string; href?: string }[] }> = {
  ...
  contact: { title: "Talk to a local property professional", eyebrow: "Contact & support", intro: "Our digital platform accepts enquiries 24 hours a day, seven days a week. The team responds at the earliest practical opportunity.", sections: [{ title: "General Enquiry", body: siteConfig.email, href: `mailto:${siteConfig.email}` }, { title: "Sales & Advertising", body: siteConfig.salesEmail, href: `mailto:${siteConfig.salesEmail}` }, { title: "NRI Services", body: siteConfig.nriEmail, href: `mailto:${siteConfig.nriEmail}` }, { title: "Voice call", body: "+91 77889 98459", href: siteConfig.phoneHref }, { title: "WhatsApp", body: "+91 99887 67689", href: siteConfig.whatsappHref }, { title: "Office", body: "4th Lane, Bhagya Nagar, Ongole, Prakasam District, Andhra Pradesh, India." }] },
