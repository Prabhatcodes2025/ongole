...
test("converts every supported area unit through square feet",()=>{assert.equal(convertArea(1,"acre","sq_ft"),43560);assert.equal(convertArea(1,"cent","sq_ft"),435.6);assert.equal(convertArea(1,"gadi","sq_yd"),1);assert.equal(convertArea(100,"sq_m","sq_ft"),1076.391);assert.equal(convertArea(240,"sq_yd","sq_ft"),2160)});
