...
const links=[["/admin","Overview"],["/admin/properties","Properties"],["/admin/enquiries","CRM"],["/admin/masters","Master data"],["/admin/reports","Reports"],["/admin/audit","Audit logs"]] as const;
