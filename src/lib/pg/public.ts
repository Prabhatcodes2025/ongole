...
export type PublicPg={
  ...
  rent:number;capacity:number|null;foodType:string;facing:string;lunchBoxAvailable:boolean;amenities:string[];rules:string[];videos:string[];nearby:{name:string;distance:number;unit:string}[];
